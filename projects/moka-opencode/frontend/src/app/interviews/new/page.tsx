    ...
    <MainLayout>
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1A1A1A] tracking-tight">安排面试</h1>
          <p className="text-sm text-[#666] mt-0.5">为候选人安排面试时间和面试官</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-[#E8EBF0] shadow-[0_1px_3px_rgba(0,0,0,0.04)] p-6 lg:p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {selectedProcess && (
                <p className="mt-1.5 text-xs text-[#4371FF]">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-[#E8EBF0] px-3.5 py-2.5 text-sm focus:border-[#4371FF] focus:ring-2 focus:ring-[#4371FF]/10 outline-none disabled:bg-slate-50 disabled:text-slate-400"
                  required
                >
