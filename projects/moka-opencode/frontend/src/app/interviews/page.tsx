          ...
          <div className="space-y-3">
            {interviews.map((interview) => (
              <div
                ...
                className="bg-white rounded-xl border border-[#E8EBF0] shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] transition-shadow duration-200 p-5 cursor-pointer"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-1.5 text-sm text-[#666]">
                      ...
                      {interview.meetingUrl && (
                        <a
                          ...
                          className="text-[#4371FF] hover:text-[#3461E6] hover:underline truncate max-w-xs"
